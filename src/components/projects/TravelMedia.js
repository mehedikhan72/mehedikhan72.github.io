    ...
    <div className="p-5">
            ...
            <div className="w-full xl:w-1/2">
              <div className="flex justify-start items-center text-4">
                ...
                <a
                  ...
                  href="https://youtu.be/5SfQz5weNSg"
                ...
                <a
                  target="_blank"
                  rel="noopener noreferrer"
                  href="https://github.com/mehedikhan72/TravelMedia"
                  className="my-btns-2 hidden md:block"
                >
                  Github
                </a>
      ...
      {detailsOn && (
        <div>
          ...
          <p className="text-2 pb-5">
            Django rest framework, React, OAuth, websockets, Django channels,
            PostgreSQL, tailwindCSS etc.
          </p>
          ...
          <p className="text-2 pb-5">
            Being my first DRF and React project, this was by far the most
